...
local t = Def.ActorFrame {
	InitCommand=function(self)
		...
		self:visible(not ThemePrefs.Get("RainbowMode") and style ~= "SRPG10" and style ~= "Technique" and style ~= "ITG" and style ~= "Transistor")
	end,
	...
	VisualStyleSelectedMessageCommand=function(self)
		...
		if ThemePrefs.Get("RainbowMode") or style == "SRPG10" or style == "Technique" or style == "ITG" or style == "Transistor" then
